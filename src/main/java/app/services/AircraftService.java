...
public interface AircraftService {
    ...
    /**
     * The method that allows to find aircraft by <b>intersection</b> of specified parameters.
     * All parameters are nullable and by this feature flexible find is available.<br><br>
     *
     * For example:<br>
     * You need to find all aircraft by model & brand, then you just should
     ...
     *
     * The result of the above call will be all Airbus A320 aircraft from the repository.
     *
     ...
     * @return all aircraft matches the specified parameters.
     */
